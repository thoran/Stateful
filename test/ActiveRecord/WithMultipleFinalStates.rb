...
describe Stateful::ActiveRecord do
  ...
  context "initial_state" do
    ...
    it "must have an initial state consistent with what is given" do
      _(machine.initial_state).must_equal ActiveRecordMachine8.stateful_states.initial_state
    end
    ...
    it "must know what it's next state is given an event name" do
      _(machine.next_state(:an_event)).must_equal ActiveRecordMachine8.stateful_states.find(:next_state)
      _(machine.next_state(:another_event)).must_equal ActiveRecordMachine8.stateful_states.find(:final_state0)
    end
  ...
  context "final_state0" do
    ...
    it "must have a final state consistent with what is given" do
      _(ActiveRecordMachine8.stateful_states.final_states).must_include machine.final_state
    end
